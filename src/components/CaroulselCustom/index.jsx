          ...
          <CarouselItem className="basis-auto relative pl-3 ">
            <div className="relative w-[326px] h-[326px]"> 
              ...
              <div className="absolute flex flex-col items-start justify-center bottom-5 left-10 w-64 gap-3">
                ...
                <Button className=" bg-yellow-main text-black text-sm font-bold w-[159px] h-[45px]"><Link href="https://pagamento.escolaconquer.com.br/CW-30102024111659533CRSTNHLND?utm_source=ITAU&utm_medium=ITAU&utm_campaign=ITAU&utm_id=ITAU&utm_term=ITAU&utm_content=ITAU" target="_blank">Matricule-se Já!</Link></Button> 
                </div>
          ...
          <CarouselItem className="basis-auto relative pl-3 ">
            <div className="relative w-[326px] h-[326px]"> 
              ...
              <div className="absolute flex flex-col items-start justify-center bottom-5 left-10 w-64 gap-3">
                ...
                <Button className=" bg-yellow-main text-black text-sm font-bold w-[159px] h-[45px]"><Link href="https://pagamento.escolaconquer.com.br/CW-30102024111515040CRSTNHLND?utm_source=ITAU&utm_medium=ITAU&utm_campaign=ITAU&utm_id=ITAU&utm_term=ITAU&utm_content=ITAU" target="_blank">Matricule-se Já!</Link></Button> 
                </div>
            ...
            <div className="relative w-[326px] h-[326px]"> 
              ...
              <div className="absolute flex flex-col items-start justify-center bottom-5 left-10 w-64 gap-3">
                ...
                <Button className=" bg-yellow-main text-black text-sm font-bold w-[159px] h-[45px]"><Link href="https://pagamento.escolaconquer.com.br/CW-30102024110058336CRSTNHLND?utm_source=ITAU&utm_medium=ITAU&utm_campaign=ITAU&utm_id=ITAU&utm_term=ITAU&utm_content=ITAU" target="_blank">Matricule-se Já!</Link></Button> 
                </div>
            ...
            <div className="relative w-[326px] h-[326px]"> 
              ...
              <div className="absolute flex flex-col items-start justify-center bottom-5 left-10 w-64 gap-3">
                ...
                <Button className=" bg-yellow-main text-black text-sm font-bold w-[159px] h-[45px]"><Link href="https://pagamento.escolaconquer.com.br/CW-30102024111609512CRSTNHLND?utm_source=ITAU&utm_medium=ITAU&utm_campaign=ITAU&utm_id=ITAU&utm_term=ITAU&utm_content=ITAU" target="_blank">Matricule-se Já!</Link></Button> 
                </div>
            ...
            <div className="relative w-[326px] h-[326px]"> 
              ...
              <div className="absolute flex flex-col items-start justify-center bottom-5 left-10 w-64 gap-3">
                ...
                <Button className=" bg-yellow-main text-black text-sm font-bold w-[159px] h-[45px]"><Link href="https://pagamento.escolaconquer.com.br/CW-30102024110557379CRSTNHLND?utm_source=ITAU&utm_medium=ITAU&utm_campaign=ITAU&utm_id=ITAU&utm_term=ITAU&utm_content=ITAU" target="_blank">Matricule-se Já!</Link></Button> 
                </div>
            ...
            <div className="relative w-[326px] h-[326px]"> 
              ...
              <div className="absolute flex flex-col items-start justify-center bottom-5 left-10 w-64 gap-3">
                ...
                <Button className=" bg-yellow-main text-black text-sm font-bold w-[159px] h-[45px]"><Link href="https://pagamento.escolaconquer.com.br/CW-30102024112740021CRSTNHLND?utm_source=ITAU&utm_medium=ITAU&utm_campaign=ITAU&utm_id=ITAU&utm_term=ITAU&utm_content=ITAU" target="_blank">Matricule-se Já!</Link></Button>
                </div>
            ...
            <div className="relative w-[326px] h-[326px]"> 
              ...
              <div className="absolute flex flex-col items-start justify-center bottom-5 left-10 w-64 gap-3">
                ...
                <Button className=" bg-yellow-main text-black text-sm font-bold w-[159px] h-[45px]"><Link href="https://pagamento.escolaconquer.com.br/CW-30102024112947687CRSTNHLND?utm_source=ITAU&utm_medium=ITAU&utm_campaign=ITAU&utm_id=ITAU&utm_term=ITAU&utm_content=ITAU" target="_blank">Matricule-se Já!</Link></Button>
                </div>
            ...
            <div className="relative w-[326px] h-[326px]"> 
              ...
              <div className="absolute flex flex-col items-start justify-center bottom-5 left-10 w-64 gap-3">
                ...
                <Button className=" bg-yellow-main text-black text-sm font-bold w-[159px] h-[45px]"><Link href="https://pagamento.escolaconquer.com.br/CW-30102024110304361CRSTNHLND?utm_source=ITAU&utm_medium=ITAU&utm_campaign=ITAU&utm_id=ITAU&utm_term=ITAU&utm_content=ITAU" target="_blank">Matricule-se Já!</Link></Button>
                </div>
          ...
          <CarouselItem className="basis-auto relative pl-3">
            <div className="relative w-[326px] h-[326px]"> 
              ...
              <div className="absolute flex flex-col items-start justify-center bottom-5 left-10 w-64 gap-3">
                ...
                <Button className=" bg-yellow-main text-black text-sm font-bold w-[159px] h-[45px]"><Link href="https://pagamento.escolaconquer.com.br/CW-30102024112237981CRSTNHLND?utm_source=ITAU&utm_medium=ITAU&utm_campaign=ITAU&utm_id=ITAU&utm_term=ITAU&utm_content=ITAU" target="_blank">Matricule-se Já!</Link></Button>
                </div>
